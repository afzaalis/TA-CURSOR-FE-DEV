...
/**
 * Halaman detail properti — implementasi prompt terstruktur (Figma-aligned).
 * Spesifikasi: palet #FFFFFF, Poppins, galeri 3fr/26%, header harga+judul+KT/KM/m², agen sticky
 * hingga sebelum peta, konten flat tanpa kartu, KPR + perumahan populer.
 */
...
export default function DetailPropertiTerstruktur() {
        ...
        <div className="mx-auto max-w-[1440px] px-5 py-12 lg:px-10">
          <section>
            <div className="mb-6 flex items-center justify-between">
              <h2
                id="perumahan-populer-heading-terstruktur"
